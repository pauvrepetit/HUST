...
public io_1, io_2, io_3, io_4, io_5, io_6, io_7, io_8, BUF1, bufF2T10, DAT, SIGN, auth
.386
...
data segment use16
	...
	bpass	DB	0dch, 0cfh, 0d1h, 58h, 0dch, 45h, 77h, 0aeh, 0FFH, 0, 4
	N		EQU	3	  					;number
	...
	ga1		goodStruct	<'pen$', 3, 10, ?, 56, 70, 25, ?, ?, ?, ?, 75, ?, ?, ?>
	ga2		goodStruct	<'book$', 4, 9, ?, 30, 25, 5, ?, ?, ?, ?, 29, ?, ?, ?>

	;goodStruct	N-3	dup(<'egg$', 3, 7, 35, 56, 70, 25, ?>)

	bag		goodStruct	<'bag$', 3, 10, ?, 50, numOfBag, 0, ?, ?, ?, ?, 45, ?, ?, ?>
